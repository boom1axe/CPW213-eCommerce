...
namespace eCommerce.Models
{
    ...
    public class CartHelper
    {
        ...
        /// <summary>
        /// Get the current video games from their shopping cart.
        ...
        /// <summary>
        /// adds video game to cart data.
        /// Creates cookie if cookie null
        /// </summary>
        /// <param name="accessor"></param>
        /// <param name="g"></param>
        public static void Add(IHttpContextAccessor accessor, VideoGame g)
        {
            ...
            accessor.HttpContext.Response.Cookies.Append(CartCookie, value: data);
